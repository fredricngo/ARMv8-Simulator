...
declare -a file_list=("movz.x" "jitmul.x" "jitsub.x" "ldurb.x" "jitlsl.x" "jitand.x" "jitaddi.x" "ldurb.x"  "step1-a-input.x" "step1-b-input.x" "movz_lsl_test.x" "step2-a-input.x"  "step2-b-input.x"  "step3-input.x" "final_test.x" "final_test-2.x")
